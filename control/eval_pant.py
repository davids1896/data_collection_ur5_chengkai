# -*- coding: utf-8 -*-
"""
Created on Tue May 21 14:37:36 2024
...
if __name__ == "__main__":
     #action = [-1.3858e-01, -0.16, -0.1480255,  2.1496e+02,  1.6391e+02,
      #    -2.7738e-02]
     ...
     #    -4.3689e-02]
     action = [ 0.00e+00,  0.00e+00,0.080]
     service.robot_action(action, "False")
     #action = [ 0.08,  0.00e+00, 0]
     #service.robot_action(action, "False")
     #action = [ 0.08,  0.04, 0]
     #service.robot_action(action, "False")
     action = [ 0.12,  0.00e+00, 0]
     service.robot_action(action, "False")
     action = [ 0.00e+00,  0.00e+00, -0.04]
     service.robot_action(action, "False")
     #action = [-0.10, 0, 0]
     #service.robot_action(action, "False")
     action = [0,  -1.20e-01, 0]
     service.robot_action(action, "False")
     action = [ 0.00e+00,  0.00e+00,0.06]
     service.robot_action(action, "False")
     action = [ -1.20e-01,  0.00e+00, 0]
     service.robot_action(action, "False")
